...
export const TIPO_EQUIPO_OPCIONES: TipoEquipoOption[] = [
  ...
  { value: "reparado_fabrica", label: "Equipo reparado en fábrica", id: "tipo-fabrica" },
  { value: "reparado_vimesa", label: "Equipo reparado en Vimesa", id: "tipo-vimesa" },
];
...
export const CELLNEX_OPCIONES: CellnexOption[] = [
  ...
  { value: "audio_lr", label: "Nivel de entrada Audio L&R: 14.5 dBu", id: "cx-audio-lr" },
  { value: "audio_mpx", label: "Nivel de entrada Audio MPX: 4.1 dBu", id: "cx-mpx" },
