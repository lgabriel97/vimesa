...
export function VerificacionFmDetalle({ informe }: Props) {
  ...
  return (
    <>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Mediciones — Cámara climática</CardTitle>
        </CardHeader>
        <CardContent>
          {medidasCamara.length === 0 ? (
            <p className="text-sm text-muted-foreground">No presentado</p>
          ) : (
            <div className="overflow-x-auto">
              <Table>
